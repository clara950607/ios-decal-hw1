...
//: [They could be the same type but since the values we pass in may not be string, they could be different type too.]
...
//:[We need to add class before func.]
...
//: [We have not initialized the countLetter dictionary in line X.]
